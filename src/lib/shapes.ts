export type ShapeId = "cube" | "cylinder" | "sphere" | "capsule" | "cone" | "egg" | "tube"
...
export const SPHERE_CONTROLS: ControlDef[] = [
  { key: "radius", label: "RADIUS", min: 0.2, max: 1.5, step: 0.01 },
]
